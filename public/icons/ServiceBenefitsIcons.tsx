// Animated SVG icons for all service benefits with original linear gradient colors
...
export const RecognizedVisualIdentity = () => {
  return (
    ...
    >
      ...
      <path
        className="cls-1"
        d="M13.79,31.86l-.49.42a1,1,0,0,0,.3,1.65l.08,0a1,1,0,0,0,.92-.15A16.46,16.46,0,0,0,16,32.55h0A23,23,0,0,0,23,16a3,3,0,0,0-6,0,17,17,0,0,1-7,13.73c-.19.14-.38.28-.58.41a1,1,0,0,0,0,1.63l.06,0a1,1,0,0,0,1.08,0q.65-.44,1.26-.93A19,19,0,0,0,19,16a1,1,0,0,1,2,0A20.94,20.94,0,0,1,13.79,31.86Z"
      ></path>
      <path
        className="cls-1"
        d="M18.64,35h.07a1,1,0,0,0,.78-.3c.52-.54,1-1.1,1.48-1.69a26.83,26.83,0,0,0,6-17,7,7,0,0,0-14,0A13,13,0,0,1,7,27l-.71.44a1,1,0,0,0-.25,1.51l0,.05a1,1,0,0,0,1.18.18c.39-.22.77-.45,1.15-.71A15,15,0,0,0,15,16a5,5,0,0,1,10,0A24.89,24.89,0,0,1,18.39,33c-.12.14-.25.27-.37.4A1,1,0,0,0,18.64,35Z"
      ></path>
      <path
        className="cls-1"
        d="M24.54,34.49l.1,0a1,1,0,0,0,.55-.39,28.79,28.79,0,0,0,1.6-2.46A30.77,30.77,0,0,0,31,16,11,11,0,0,0,9,16a9,9,0,0,1-4.2,7.6,9.34,9.34,0,0,1-.87.5,1,1,0,0,0-.42,1.34l0,.06a1,1,0,0,0,1.28.39c.34-.17.66-.35,1-.55A11,11,0,0,0,11,16a9,9,0,0,1,18,0,28.79,28.79,0,0,1-5.22,16.57c-.08.13-.17.25-.26.38A1,1,0,0,0,24.54,34.49Z"
      ></path>
      <path
        className="cls-1"
        d="M1.85,21.66a1,1,0,0,0,1.37.6A6.28,6.28,0,0,0,4,21.78,7,7,0,0,0,7,16a13,13,0,0,1,26,0,33.07,33.07,0,0,1-.35,4.8,1.06,1.06,0,0,0,1.76.94l0,0a.41.41,0,0,0,.13-.25A34,34,0,0,0,35,16h0A15,15,0,0,0,5,16,5,5,0,0,1,3.41,19.7a4.71,4.71,0,0,1-1.09.78,1,1,0,0,0-.49,1.12Z"
      ></path>
      <path
        className="cls-2"
        d="M39.82,23.44l-.88-1.8a14.72,14.72,0,0,0-1.81,1.05l1.11,1.66A13.76,13.76,0,0,1,39.82,23.44Z"
      ></path>
      <path
        className="cls-2"
        d="M58.55,29.79l1.79-.89a15.37,15.37,0,0,0-1.05-1.8l-1.66,1.11A14.76,14.76,0,0,1,58.55,29.79Z"
      ></path>
      <path
        className="cls-2"
        d="M54.88,22.69a16.28,16.28,0,0,0-1.81-1l-.88,1.79a14.76,14.76,0,0,1,1.58.92Z"
      ></path>
      <path
        className="cls-2"
        d="M56.52,26.76,58,25.44A15.79,15.79,0,0,0,56.54,24l-1.32,1.5A14.39,14.39,0,0,1,56.52,26.76Z"
      ></path>
      <path
        className="cls-2"
        d="M43.27,22.27l-.38-2a16.65,16.65,0,0,0-2,.54l.64,1.9A12,12,0,0,1,43.27,22.27Z"
      ></path>
      <path
        className="cls-2"
        d="M46,22l1,0,.13-2q-.52,0-1,0c-.34,0-.7,0-1,0l.13,2Q45.53,22,46,22Z"
      ></path>
      <path
        className="cls-2"
        d="M51.14,20.84a17.69,17.69,0,0,0-2-.54l-.39,2a12.15,12.15,0,0,1,1.77.47Z"
      ></path>
      <path
        className="cls-2"
        d="M61.7,39.09l-2-.39a13.57,13.57,0,0,1-.47,1.77l1.9.64A15.8,15.8,0,0,0,61.7,39.09Z"
      ></path>
      <path
        className="cls-2"
        d="M59.73,33.24l2-.39a17.69,17.69,0,0,0-.54-2l-1.9.65A13.47,13.47,0,0,1,59.73,33.24Z"
      ></path>
      <path
        className="cls-2"
        d="M57.66,43.74l1.66,1.11a16.37,16.37,0,0,0,1-1.81l-1.8-.88A12.43,12.43,0,0,1,57.66,43.74Z"
      ></path>
      <path
        className="cls-2"
        d="M60,36c0,.3,0,.59,0,.89L62,37c0-.33,0-.67,0-1s0-.72,0-1.08l-2,.14C60,35.37,60,35.68,60,36Z"
      ></path>
      <path
        className="cls-1"
        d="M46,40a4,4,0,1,0-4-4A4,4,0,0,0,46,40Zm0-6a2,2,0,1,1-2,2A2,2,0,0,1,46,34Z"
      ></path>
      <path
        className="cls-1"
        d="M30,36v.64L25.7,41.8a3,3,0,0,0-.7,1.92V44a3,3,0,0,0,3,3h2v5a3,3,0,0,0,3,3h5v7a1,1,0,0,0,1,1H59a1,1,0,0,0,1-1.15L57.66,46.93l-.07-.48a1,1,0,0,0-.27-.55h0l-5-5A7.9,7.9,0,0,0,54,36a8,8,0,0,0-8-8,7.92,7.92,0,0,0-4.9,1.69L35.42,24A15.89,15.89,0,0,0,30,36Zm16-6a6,6,0,1,1-6,6A6,6,0,0,1,46,30ZM35.42,26.84l4.27,4.26A7.92,7.92,0,0,0,38,36a8,8,0,0,0,8,8,7.9,7.9,0,0,0,4.89-1.69l4.77,4.77L57.83,61H40V54a1,1,0,0,0-1-1H33a1,1,0,0,1-1-1V51h5V49H32V47h2V45H28a1,1,0,0,1-1-1v-.28a1,1,0,0,1,.23-.64l4.54-5.44A1,1,0,0,0,32,37V36A13.86,13.86,0,0,1,35.42,26.84Z"
      ></path>
    </svg>
  );
};
