      ...
      <div className="relative overflow-hidden flex flex-col gap-6 items-start">
        ...
        <div className="grid grid-cols-2 gap-6 items-center">
          <div className="flex flex-col gap-2">
            ...
            <h3 className="w-full text-[#ffffff] font-semibold text-2xl xs:text-3xl text-start z-20">
            Stay Humble
          </h3>
          ...
          <Image src={TestHumanImage} alt="image" width={0} height={0} />
        </div>

        <div className="grid grid-cols-3 gap-6">
          <div className="flex flex-col bg-gradient-to-t from-[#0b0b0b] to-[#27a5ff2b] overflow-hidden relative  gap-2 rounded-lg p-4 py-8 border-[0.5px] border-[#252525] z-20">
            <h3 className="w-full text-[#ffffff] font-semibold text-2xl xs:text-3xl text-start z-20">
              Stay Humble
            </h3>
