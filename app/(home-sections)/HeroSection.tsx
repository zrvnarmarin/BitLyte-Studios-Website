  ...
  return (
    <HeroSectionWrapper>
      ...
      <ul className="relative w-full flex items-center justify-center gap-6 z-30">
        <li className="w-fit hover:bg-gradient-to-r from-[#0b0b0b] to-[#131313] flex gap-2 items-center justify-center text-base text-[#eeeeee] font-normal z-20 rounded-full border-[0.5px] border-[#252525] px-4 py-2">
          Web Development
        </li>
        <li className="w-fit hover:bg-gradient-to-r from-[#0b0b0b] to-[#131313] flex gap-2 items-center justify-center text-base text-[#eeeeee] font-normal z-20 rounded-full border-[0.5px] border-[#252525] px-4 py-2">
          Digital Marketing
