    ...
    <SectionWrapper>
      ...
      <div className="px-5 sm:px-16 flex items-center justify-center bg-[#0b0b0b] border-[#1d263f] rounded-lg ">
        ...
        <p className="text-3xl xs:text-4xl sm:text-5xl text-[#ffffff] text-center xs:font-normal z-20 lg:px-24">
          Building an <span className="custom-text">online presence</span> and trust with your customers is
          <span className="custom-text"> vital</span> for <span className="custom-text">growing the business</span>. With our robust development and
          targeted design, your <span className="custom-text">time is saved</span> and your <span className="custom-text">
              energy converts to
              profits
          </span>.
        </p>
