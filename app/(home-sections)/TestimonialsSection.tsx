...
export const TestimonialCard = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-lg flex flex-row items-center  border-[0.5px] border-[#252525] px-24 py-24">
      {/* Blur background */}
      ...
      <div className="flex flex-col z-20">
        ...
        <p className="w-full text-4xl text-[#ffffff] font-light leading-snug text-center z-20">
          {testimonialText}
        </p>
        <div className="flex items-center justify-center gap-2 pt-12">
          <Image src={imageSrc} alt="testimonial image" />
          <p className="flex flex-col items-center gap-1">
            <span className="w-full text-2xl text-[#ffffff] font-semibold">
              {name}
            </span>
            <span className="w-full text-lg text-[#eeeeee] font-normal ">
              {companyName}
            </span>
          </p>
        </div>
