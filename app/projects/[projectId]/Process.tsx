  ...
  return (
    <div key={id} className={`relative overflow-hidden`}>
      ...
      <div className="relative  flex flex-col items-center justify-center gap-4 py-2">
        <span style={{ borderColor: borderColor }} className="w-0.5 h-10 border-[0.5px] "></span>
      </div>

      {/* Goals heading */}
      {/* <div className="w-full relative flex flex-col gap-2">
        <div style={{ ...generalGradientStyle, borderColor: colorGradient }} className={`w-full flex gap-2 items-center justify-center text-[#ffffff] font-medium text-xl lg:text-xl border-[0.5px] border-[#4b4d1e] z-20 rounded-full px-4 py-2`}>
      ...
      <div className="flex flex-wrap justify-center items-start gap-2 pt-2">
        {goals.map((goal) => (
          <div
            ...
            className="w-full flex gap-2 items-center justify-center text-[#ffffff] font-medium text-xl lg:text-xl border-[0.5px] z-20 rounded-full px-6 py-2"
          >
