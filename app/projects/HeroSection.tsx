    ...
    <HeroSectionWrapper>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
        ...
        <div className="order-2 lg:order-1 flex flex-col gap-6">
          {/* <div className="w-64 h-64 md:w-96 md:h-96 absolute left-0 bg-gradient-to-r from-[#1A9FFF] to-[#0086E6] z-10 blur-[430px]"></div> */}
          ...
          <p className="text-xl font-light text-[#ffffff] text-center lg:text-left z-20">
            We are on a mission to design and develop projects that tell stories, spark emotions, and drive success in the end.
            Let`s make sure we do the same to your business.
          </p>
