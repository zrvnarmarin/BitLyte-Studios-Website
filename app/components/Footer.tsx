    ...
    return (
        <footer className="relative w-full pt-8 pb-8 px-8 md:px-14 lg:px-24 xl:px-28 2xl:px-32 3xl:px-72">
            ...
            <div className="relative z-10 w-full flex flex-col items-start gap-2">
                    ...
                    {quickLinkRoutes.map(routeLink =>
                        <React.Fragment key={routeLink.id}>
                            <Link href={routeLink.href}>
                                <p className="text-base text-[#ffffff] font-normal">{routeLink.title}</p>
                            </Link>
                        </React.Fragment>
                    )}
                </div>
                ...
                {/* Social media links */}
                <div className="flex flex-col pt-6 gap-2">
                    <p className="text-xs md:text-md font-bold text-[#dddddd] uppercase">Contact info</p>
                ...
                <div className="flex flex-col gap-2 pt-6">
                    <p className="text-xs text-[#dddddd] font-light">©2024 BitLyte Studios. All rights reserved.</p>
                    <p className="text-xs text-[#dddddd] font-light">Developed by Marin Zrvnar</p>
                </div>

                {/* Terms and privacy */}
                <div className="w-full flex items-center justify-start gap-2 ">
                    <p className="text-xs text-[#dddddd] font-light">Terms And Conditions</p>
    ...
    return (
        <svg className="w-full h-full" preserveAspectRatio="none" viewBox="0 0 1440 560">
            <g mask="url(#SvgjsMask1463)" fill="none">
                <rect width="1440" height="560" x="0" y="0" fill="url(#SvgjsLinearGradient1464)"></rect>
                <path d="M 0,362 C 144,323 432,178.8 720,167 C 1008,155.2 1296,275.8 1440,303L1440 560L0 560z" fill="rgba(0, 62, 106, 1)"></path>
            </g>
            <defs>
                <mask id="SvgjsMask1463">
                    <rect width="1440" height="560" fill="#ffffff"></rect>
                </mask>
                <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" gradientUnits="userSpaceOnUse" id="SvgjsLinearGradient1464">
...
export const XIcon = () => {
    return (
        <svg width="27" height="27" viewBox="0 0 19 20" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.307 8.54539L18.3798 0.500244H16.7034L10.5638 7.48546L5.65767 0.500244H0L7.41784 11.0642L0 19.5002H1.67635L8.16102 12.1228L13.3423 19.5002H19L11.307 8.54539ZM9.01176 11.1565L8.2602 10.1047L2.27983 1.73524H4.85442L9.67951 8.48974L10.4311 9.54153L16.7048 18.3222H14.1302L9.01176 11.1565Z" fill="#ffffff"/>
        </svg>
    )
}
