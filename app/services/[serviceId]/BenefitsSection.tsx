...
export const BenefitCard = ({
  ...
  return (
    ...
    >
      ...
      {/* Blur background */}
      <div className="w-full h-full absolute inset-0 bg-gradient-to-r from-[#0b0b0b] to-[#4F65A9] z-10 blur-[130px]"></div>
...
export const businessBenefits: BusinessBenefitsCardType[] = [
  ...
  },
  {
    ...
    description: "Landing pages allow for highly targeted messaging tailored to specific audiences or campaigns. This ensures that the content resonates with the visitor’s needs and interests, improving the relevance and effectiveness of your marketing efforts.",
...
export const LandingPageIcon = () => {
  return (
    <svg id="Layer_1" data-name="Layer 1" viewBox="0 0 63.97 41.71" width={200} height={200}>
    <defs>
      <style>
        {`
          .cls-1 {
...
export const BoostedEngagement = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width="200" height="200" version="1.1" style={{ shapeRendering: 'geometricPrecision', textRendering: 'geometricPrecision', fillRule: 'evenodd', clipRule: 'evenodd' }} viewBox="0 0 8333 8333">
    <defs>
      <style type="text/css">
        {`
          .fil0 {fill:#282828}
    ...
    <g id="Layer_x0020_1">
      ...
      <path className="fil0" d="M7364 5973l-6394 0c-67,0 -121,-54 -121,-120l0 -2834c0,-67 54,-121 121,-121 66,0 120,54 120,121l0 2713 6153 0 0 -2717c0,-67 54,-121 121,-121 66,0 120,54 120,121l0 2838c0,66 -54,120 -120,120zm-1666 -3983l-3059 0c-67,0 -121,-54 -121,-120 0,-67 54,-121 121,-121l3059 0c67,0 121,54 121,121 0,66 -54,120 -121,120z"></path>
      <path className="fil0" d="M5032 6751l-1731 0c-67,0 -121,-55 -121,-121l0 -777c0,-67 54,-121 121,-121l1731 0c67,0 121,54 121,121l0 777c0,66 -54,121 -121,121zm-1610 -242l1489 0 0 -536 -1489 0 0 536z"></path>
      <path className="fil0" d="M5580 7342l-2826 0c-67,0 -121,-54 -121,-120l0 -592c0,-67 54,-121 121,-121l2826 0c66,0 120,54 120,121l0 592c0,66 -54,120 -120,120zm-2706 -241l2585 0 0 -350 -2585 0 0 350z"></path>
      <path className="fil0" d="M5259 3136l-2185 0c-67,0 -121,-54 -121,-121 0,-67 54,-121 121,-121l2185 0c67,0 121,54 121,121 0,67 -54,121 -121,121z"></path>
      <path className="fil0" d="M6200 3658l-4067 0c-67,0 -121,-54 -121,-121 0,-66 54,-120 121,-120l4067 0c67,0 121,54 121,120 0,67 -54,121 -121,121z"></path>
      <path className="fil0" d="M7601 3136l-1903 0c-67,0 -121,-54 -121,-121l0 -1903c0,-67 54,-121 121,-121l1903 0c67,0 121,54 121,121l0 1903c0,67 -54,121 -121,121zm-1782 -242l1661 0 0 -1661 -1661 0 0 1661z"></path>
      <path className="fil0" d="M6713 3136l-1015 0c-43,0 -83,-23 -105,-61 -21,-37 -21,-84 1,-121l507 -872c22,-37 62,-60 105,-60 43,0 82,23 104,60l368 632c34,58 14,132 -44,165 -13,8 -26,13 -40,15l119 0c67,0 121,54 121,121 0,67 -54,121 -121,121zm-805 -242l646 0c-34,-6 -66,-26 -85,-58l-263 -453 -298 511z"></path>
      <path className="fil0" d="M7601 3136l-1167 0c-43,0 -83,-23 -105,-61 -21,-37 -21,-84 1,-121l647 -1112c21,-37 61,-60 104,-60l0 0c43,0 83,23 105,60l520 894c33,57 14,131 -44,165 -3,2 -6,3 -9,5 41,19 69,61 69,109 0,67 -54,121 -121,121zm-957 -242l886 0c-13,-9 -24,-22 -33,-37l-416 -714 -437 751z"></path>
      <path className="fil0" d="M1249 2695c-21,0 -42,-6 -60,-16 -38,-22 -61,-62 -61,-105l0 -1017c0,-43 23,-83 61,-105 37,-21 83,-21 120,0l874 509c37,22 60,61 60,104 0,43 -23,83 -60,105l-873 508c-19,11 -40,17 -61,17zm120 -928l0 597 514 -299 -514 -298z"></path>
      <path className="fil0" d="M4956 5973l-1578 0c-67,0 -121,-54 -121,-120l0 -363c0,-266 217,-483 483,-483l853 0c267,0 484,217 484,483l0 363c0,66 -54,120 -121,120zm-1458 -241l1337 0 0 -242c0,-133 -108,-242 -242,-242l-853 0c-133,0 -242,109 -242,242l0 242 0 0z"></path>
      <path className="fil0" d="M4167 4888c-299,0 -542,-243 -542,-542 0,-298 243,-541 542,-541 298,0 541,243 541,541 0,299 -243,542 -541,542zm0 -842c-166,0 -301,135 -301,300 0,166 135,301 301,301 165,0 300,-135 300,-301 0,-165 -135,-300 -300,-300z"></path>
      <path className="fil0" d="M2958 5973l-1578 0c-67,0 -121,-54 -121,-120l0 -363c0,-266 217,-483 483,-483l853 0c267,0 484,217 484,483l0 363c0,66 -54,120 -121,120zm-1458 -241l1337 0 0 -242c0,-133 -108,-242 -242,-242l-853 0c-133,0 -242,109 -242,242l0 242z"></path>
      <path className="fil0" d="M2169 4888c-299,0 -542,-243 -542,-542 0,-298 243,-541 542,-541 298,0 541,243 541,541 0,299 -243,542 -541,542zm0 -842c-166,0 -301,135 -301,300 0,166 135,301 301,301 165,0 300,-135 300,-301 0,-165 -135,-300 -300,-300z"></path>
      <path className="fil0" d="M6954 5973l-1578 0c-67,0 -121,-54 -121,-120l0 -363c0,-266 217,-483 483,-483l853 0c267,0 484,217 484,483l0 363c0,66 -54,120 -121,120zm-1458 -241l1337 0 0 -242c0,-133 -108,-242 -242,-242l-853 0c-133,0 -242,109 -242,242l0 242 0 0z"></path>
      <path className="fil0" d="M6165 4888c-299,0 -542,-243 -542,-542 0,-298 243,-541 542,-541 298,0 541,243 541,541 0,299 -243,542 -541,542zm0 -842c-166,0 -300,135 -300,300 0,166 134,301 300,301 165,0 300,-135 300,-301 0,-165 -135,-300 -300,-300z"></path>
    </g>
  </svg>
  )
}
...
export const RecognizedVisualIdentity = () => {
  return (
      <svg
        ...
        height={200}
      >
        <path d="M13.79,31.86l-.49.42a1,1,0,0,0,.3,1.65l.08,0a1,1,0,0,0,.92-.15A16.46,16.46,0,0,0,16,32.55h0A23,23,0,0,0,23,16a3,3,0,0,0-6,0,17,17,0,0,1-7,13.73c-.19.14-.38.28-.58.41a1,1,0,0,0,0,1.63l.06,0a1,1,0,0,0,1.08,0q.65-.44,1.26-.93A19,19,0,0,0,19,16a1,1,0,0,1,2,0A20.94,20.94,0,0,1,13.79,31.86Z"></path>
        <path d="M18.64,35h.07a1,1,0,0,0,.78-.3c.52-.54,1-1.1,1.48-1.69a26.83,26.83,0,0,0,6-17,7,7,0,0,0-14,0A13,13,0,0,1,7,27l-.71.44a1,1,0,0,0-.25,1.51l0,.05a1,1,0,0,0,1.18.18c.39-.22.77-.45,1.15-.71A15,15,0,0,0,15,16a5,5,0,0,1,10,0A24.89,24.89,0,0,1,18.39,33c-.12.14-.25.27-.37.4A1,1,0,0,0,18.64,35Z"></path>
        <path d="M24.54,34.49l.1,0a1,1,0,0,0,.55-.39,28.79,28.79,0,0,0,1.6-2.46A30.77,30.77,0,0,0,31,16,11,11,0,0,0,9,16a9,9,0,0,1-4.2,7.6,9.34,9.34,0,0,1-.87.5,1,1,0,0,0-.42,1.34l0,.06a1,1,0,0,0,1.28.39c.34-.17.66-.35,1-.55A11,11,0,0,0,11,16a9,9,0,0,1,18,0,28.79,28.79,0,0,1-5.22,16.57c-.08.13-.17.25-.26.38A1,1,0,0,0,24.54,34.49Z"></path>
        <path d="M1.85,21.66a1,1,0,0,0,1.37.6A6.28,6.28,0,0,0,4,21.78,7,7,0,0,0,7,16a13,13,0,0,1,26,0,33.07,33.07,0,0,1-.35,4.8,1.06,1.06,0,0,0,1.76.94l0,0a.41.41,0,0,0,.13-.25A34,34,0,0,0,35,16h0A15,15,0,0,0,5,16,5,5,0,0,1,3.41,19.7a4.71,4.71,0,0,1-1.09.78,1,1,0,0,0-.49,1.12Z"></path>
        <path d="M39.82,23.44l-.88-1.8a14.72,14.72,0,0,0-1.81,1.05l1.11,1.66A13.76,13.76,0,0,1,39.82,23.44Z"></path>
        <path d="M58.55,29.79l1.79-.89a15.37,15.37,0,0,0-1.05-1.8l-1.66,1.11A14.76,14.76,0,0,1,58.55,29.79Z"></path>
        <path d="M54.88,22.69a16.28,16.28,0,0,0-1.81-1l-.88,1.79a14.76,14.76,0,0,1,1.58.92Z"></path>
        <path d="M56.52,26.76,58,25.44A15.79,15.79,0,0,0,56.54,24l-1.32,1.5A14.39,14.39,0,0,1,56.52,26.76Z"></path>
        <path d="M43.27,22.27l-.38-2a16.65,16.65,0,0,0-2,.54l.64,1.9A12,12,0,0,1,43.27,22.27Z"></path>
        <path d="M46,22l1,0,.13-2q-.52,0-1,0c-.34,0-.7,0-1,0l.13,2Q45.53,22,46,22Z"></path>
        <path d="M51.14,20.84a17.69,17.69,0,0,0-2-.54l-.39,2a12.15,12.15,0,0,1,1.77.47Z"></path>
        <path d="M61.7,39.09l-2-.39a13.57,13.57,0,0,1-.47,1.77l1.9.64A15.8,15.8,0,0,0,61.7,39.09Z"></path>
        <path d="M59.73,33.24l2-.39a17.69,17.69,0,0,0-.54-2l-1.9.65A13.47,13.47,0,0,1,59.73,33.24Z"></path>
        <path d="M57.66,43.74l1.66,1.11a16.37,16.37,0,0,0,1-1.81l-1.8-.88A12.43,12.43,0,0,1,57.66,43.74Z"></path>
        <path d="M60,36c0,.3,0,.59,0,.89L62,37c0-.33,0-.67,0-1s0-.72,0-1.08l-2,.14C60,35.37,60,35.68,60,36Z"></path>
        <path d="M46,40a4,4,0,1,0-4-4A4,4,0,0,0,46,40Zm0-6a2,2,0,1,1-2,2A2,2,0,0,1,46,34Z"></path>
        <path d="M30,36v.64L25.7,41.8a3,3,0,0,0-.7,1.92V44a3,3,0,0,0,3,3h2v5a3,3,0,0,0,3,3h5v7a1,1,0,0,0,1,1H59a1,1,0,0,0,1-1.15L57.66,46.93l-.07-.48a1,1,0,0,0-.27-.55h0l-5-5A7.9,7.9,0,0,0,54,36a8,8,0,0,0-8-8,7.92,7.92,0,0,0-4.9,1.69L35.42,24A15.89,15.89,0,0,0,30,36Zm16-6a6,6,0,1,1-6,6A6,6,0,0,1,46,30ZM35.42,26.84l4.27,4.26A7.92,7.92,0,0,0,38,36a8,8,0,0,0,8,8,7.9,7.9,0,0,0,4.89-1.69l4.77,4.77L57.83,61H40V54a1,1,0,0,0-1-1H33a1,1,0,0,1-1-1V51h5V49H32V47h2V45H28a1,1,0,0,1-1-1v-.28a1,1,0,0,1,.23-.64l4.54-5.44A1,1,0,0,0,32,37V36A13.86,13.86,0,0,1,35.42,26.84Z"></path>
      </svg>
  )
}
  ...
  <svg viewBox="0 0 64 64" width="200" height="200">
    <g id="Responsive-2" data-name="Responsive">
      <path
        ...
        fill="#282828"
      />
      <rect x="25" y="5" width="4" height="2" fill="#282828" />
      <rect x="21" y="5" width="2" height="2" fill="#282828" />
      <rect x="49" y="21" width="4" height="2" fill="#282828" />
      <rect x="45" y="21" width="2" height="2" fill="#282828" />
      <rect x="46" y="57" width="4" height="2" fill="#282828" />
      <path
      ...
      <path
        ...
        fill="#282828"
      />
      <rect x="20" y="36" width="12" height="2" fill="#282828" />
      <rect x="20" y="40" width="12" height="2" fill="#282828" />
      <rect x="20" y="44" width="12" height="2" fill="#282828" />
      <path
        d="M45,44H39a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h6a1,1,0,0,0,1-1V45A1,1,0,0,0,45,44Zm-1,6H40V46h4Z"
        fill="#282828"
      />
      <rect x="48" y="45" width="10" height="2" fill="#282828" />
      <rect x="48" y="49" width="10" height="2" fill="#282828" />
    </g>
  </svg>
);
    ...
    <g id="Layer_x0020_1">
      ...
      <g id="_297491360">
        <g>
          <path
            style={{ fill: '#282828' }}
            d="M1681 1699l-1655 0c-14,0 -26,-11 -26,-26l0 -1640c0,-14 12,-26 26,-26 14,0 26,12 26,26l0 1614 1629 0c14,0 26,12 26,26 0,15 -12,26 -26,26z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M382 1699l-183 0c-15,0 -26,-11 -26,-26l0 -318c0,-14 11,-26 26,-26l183 0c15,0 26,12 26,26l0 318c0,15 -11,26 -26,26zm-157 -52l132 0 0 -266 -132 0 0 266z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M753 1699l-184 0c-14,0 -25,-11 -25,-26l0 -451c0,-14 11,-26 25,-26l184 0c15,0 26,12 26,26l0 451c0,15 -11,26 -26,26zm-158 -52l132 0 0 -399 -132 0 0 399z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M1124 1699l-184 0c-14,0 -26,-11 -26,-26l0 -605c0,-14 12,-25 26,-25l184 0c14,0 26,11 26,25l0 605c0,15 -12,26 -26,26zm-158 -52l132 0 0 -553 -132 0 0 553z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M1495 1699l-184 0c-14,0 -26,-11 -26,-26l0 -733c0,-15 12,-26 26,-26l184 0c14,0 26,11 26,26l0 733c0,15 -12,26 -26,26zm-158 -52l132 0 0 -682 -132 0 0 682z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M291 1191c-8,0 -16,-4 -21,-10l-122 -161c-8,-11 -6,-28 5,-36 12,-9 28,-7 37,5l75 99 0 -275c0,-14 11,-26 26,-26 14,0 25,12 25,26l0 352c0,11 -7,21 -17,25 -3,0 -6,1 -8,1z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M291 1191c-3,0 -6,-1 -9,-1 -10,-4 -17,-14 -17,-25l0 -352c0,-14 11,-26 26,-26 14,0 25,12 25,26l0 275 75 -99c9,-12 25,-14 37,-5 11,8 13,25 5,36l-122 161c-5,6 -12,10 -20,10z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M1403 868c-8,0 -15,-3 -20,-9l-121 -145c-10,-11 -8,-28 3,-37 11,-9 27,-8 36,3l76 91 0 -247c0,-14 12,-26 26,-26 14,0 26,12 26,26l0 318c0,11 -7,21 -17,25 -3,1 -6,1 -9,1z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M1403 868c-3,0 -6,0 -9,-1 -10,-4 -17,-14 -17,-25l0 -318c0,-14 12,-26 26,-26 14,0 26,12 26,26l0 247 76 -91c9,-11 25,-12 36,-3 11,9 13,26 3,37l-121 145c-5,6 -12,9 -20,9z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M1032 993c-7,0 -15,-4 -20,-9l-121 -146c-9,-11 -8,-27 3,-36 11,-9 27,-8 37,3l75 91 0 -247c0,-15 12,-26 26,-26 14,0 26,11 26,26l0 318c0,11 -7,20 -17,24 -3,1 -6,2 -9,2z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M1032 993c-3,0 -6,-1 -9,-2 -10,-3 -17,-13 -17,-24l0 -318c0,-15 12,-26 26,-26 14,0 26,11 26,26l0 247 76 -91c9,-11 25,-12 36,-3 11,9 13,25 4,36l-122 146c-5,5 -12,9 -20,9z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M684 710c-191,0 -346,-156 -346,-346 0,-191 155,-346 346,-346 191,0 346,155 346,346 0,190 -155,346 -346,346zm0 -641c-162,0 -294,132 -294,295 0,162 132,294 294,294 163,0 295,-132 295,-294 0,-163 -132,-295 -295,-295z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M684 242c-14,0 -26,-11 -26,-26l0 -62c0,-14 12,-26 26,-26 15,0 26,12 26,26l0 62c0,15 -11,26 -26,26z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M684 599c-14,0 -26,-12 -26,-26l0 -62c0,-14 12,-26 26,-26 15,0 26,12 26,26l0 62c0,14 -11,26 -26,26z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M878 526c-5,0 -10,-1 -14,-4 -12,-9 -15,-25 -7,-36 49,-70 53,-157 12,-229 -7,-12 -3,-28 9,-35 13,-7 28,-3 36,9 51,90 46,199 -14,284 -5,8 -13,11 -22,11z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M477 509c-9,0 -17,-5 -22,-13 -52,-89 -46,-198 14,-284 8,-12 24,-15 36,-6 12,8 14,24 6,36 -48,69 -53,156 -11,228 7,13 3,28 -10,36 -4,2 -8,3 -13,3z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M661 1145c-7,0 -14,-4 -19,-10l-122 -145c-9,-11 -8,-27 3,-36 11,-9 28,-8 37,3l76 91 0 -247c0,-15 11,-26 25,-26 15,0 26,11 26,26l0 318c0,11 -7,20 -17,24 -3,1 -6,2 -9,2z"
          ></path>
          <path
            style={{ fill: '#282828' }}
            d="M661 1145c-3,0 -6,-1 -8,-2 -11,-3 -17,-13 -17,-24l0 -318c0,-15 11,-26 25,-26 15,0 26,11 26,26l0 247 76 -91c9,-11 26,-12 37,-3 10,9 12,25 3,36l-122 146c-5,5 -12,9 -20,9z"
          ></path>
        </g>
      </g>
    </g>
