...
export default function BenefitsSection() {
    return (
        <SectionWrapper>
            <p className="w-full text-3xl text-[#ffffff]">
            ...
            <div className="relative w-full flex items-center justify-center bg-red-400 h-full pt-8">
            ...
            <p className="text-lg text-[#ffffff] font-semibold pt-8">
